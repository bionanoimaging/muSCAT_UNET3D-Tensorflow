...
def configure():
    ...
    # h5_data_sa
    flags.DEFINE_string('data_dir', '/media/useradmin/Data/Benedict/Dropbox/Dokumente/Promotion/PROJECTS/multiSCAT/MATLAB/Kamilov-BPMSimulation/DATASETUNET/', 'Name of data file(s)')
    #flags.DEFINE_string('data_dir', '/Users/bene/Dropbox/Dokumente/Promotion/PROJECTS/multiSCAT/PYTHON/Unet_3D-master/h5_data_sa/', 'Name of data file(s)')
    ...
    flags.DEFINE_integer('validation_id', 1, '1-10, which subject is used for validation')
    flags.DEFINE_integer('patch_size', 128, 'patch size')
    flags.DEFINE_integer('overlap_stepsize', 1, 'overlap stepsize when performing testing')
    ...
    flags.DEFINE_integer('depth', 128, 'depth size') # should be equal to patch_size
    flags.DEFINE_integer('height', 128, 'height size') # should be equal to patch_size
    flags.DEFINE_integer('width', 128, 'width size') # should be equal to patch_size
    # Debug
    ...
    flags.DEFINE_integer('test_step', 150, 'Test or predict model at this step')
